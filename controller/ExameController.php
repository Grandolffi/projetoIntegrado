...
$definicoesExames = [
    ...
    'proteina_total' => ['Proteína Total', ''], // Adicione o valor de referência se houver
    ...
    'ureia' => ['Ureia (mg/dL)', ''], // Adicione o valor de referência se houver
    'acido_urico' => ['Ácido Úrico (mg/dL)', ''], // Adicione o valor de referência se houver
    'pcr' => ['PCR - Proteína C Reativa (mg/dL)', 'Inferior a 1,0 mg/dL'],
    'calcio' => ['Cálcio', ''], // Adicione o valor de referência se houver
    'ldh' => ['LDH', ''] // Adicione o valor de referência se houver
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Os campos abaixo não estão no modelo Exames.php, mas da para salvá-los
